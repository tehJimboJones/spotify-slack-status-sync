...
[spotify-status-bot](../../../../README.md) / [db/models/EmojiConfigSession](../README.md) / EmojiConfigSessionModel
...
- `Model`\<`EmojiConfigSessionModel`\>

## Implements

- [`EmojiConfigSession`](../../../../services/session/types/interfaces/EmojiConfigSession.md)

## Constructors

### Constructor

> **new EmojiConfigSessionModel**(`values?`, `options?`): `EmojiConfigSessionModel`
...
`Optional`\<`EmojiConfigSessionModel`, `NullishPropertiesOf`\<`EmojiConfigSessionModel`\>\>
...
`EmojiConfigSessionModel`

#### Inherited from

`Model<EmojiConfigSessionModel>.constructor`

## Properties

### ~~\_attributes~~

> **\_attributes**: `EmojiConfigSessionModel`
...
> **\_creationAttributes**: `EmojiConfigSessionModel`
...
[`EmojiConfigSession`](../../../../services/session/types/interfaces/EmojiConfigSession.md).[`channelId`](../../../../services/session/types/interfaces/EmojiConfigSession.md#channelid)
...
> **dataValues**: `EmojiConfigSessionModel`
...
[`EmojiConfigSession`](../../../../services/session/types/interfaces/EmojiConfigSession.md).[`id`](../../../../services/session/types/interfaces/EmojiConfigSession.md#id)
...
[`EmojiConfigSession`](../../../../services/session/types/interfaces/EmojiConfigSession.md).[`messageTs`](../../../../services/session/types/interfaces/EmojiConfigSession.md#messagets)
...
[`EmojiConfigSession`](../../../../services/session/types/interfaces/EmojiConfigSession.md).[`settingType`](../../../../services/session/types/interfaces/EmojiConfigSession.md#settingtype)
...
[`EmojiConfigSession`](../../../../services/session/types/interfaces/EmojiConfigSession.md).[`userId`](../../../../services/session/types/interfaces/EmojiConfigSession.md#userid)
...
> **$get**\<`K`\>(`propertyKey`, `options?`): `Promise`\<`$GetType`\<`EmojiConfigSessionModel`\[`K`\]\>\>
...
`K` *extends* keyof `EmojiConfigSessionModel`
...
`Promise`\<`$GetType`\<`EmojiConfigSessionModel`\[`K`\]\>\>
...
`SequelizeHooks`\<`Model`\<`any`, `any`\>, `EmojiConfigSessionModel`, `EmojiConfigSessionModel`\>\[`K`\]
...
`SequelizeHooks`\<`Model`\<`EmojiConfigSessionModel`, `EmojiConfigSessionModel`\>, `EmojiConfigSessionModel`, `EmojiConfigSessionModel`\>\[`K`\]
...
> **decrement**\<`K`\>(`fields`, `options?`): `Promise`\<`EmojiConfigSessionModel`\>
...
`Partial`\<`EmojiConfigSessionModel`\> \| `K` \| readonly `K`[]
...
`IncrementDecrementOptionsWithBy`\<`EmojiConfigSessionModel`\>

#### Returns

`Promise`\<`EmojiConfigSessionModel`\>
...
readonly `EmojiConfigSessionModel`[]
...
> **get**(`options?`): `EmojiConfigSessionModel`
...
> **get**\<`K`\>(`key`, `options?`): `EmojiConfigSessionModel`\[`K`\]
...
> **getDataValue**\<`K`\>(`key`): `EmojiConfigSessionModel`\[`K`\]
...
> **increment**\<`K`\>(`fields`, `options?`): `Promise`\<`EmojiConfigSessionModel`\>
...
> **previous**\<`K`\>(`key`): `EmojiConfigSessionModel`\[`K`\] \| `undefined`
...
`EmojiConfigSessionModel`\[`K`\] \| `undefined`
...
> **reload**(`options?`): `Promise`\<`EmojiConfigSessionModel`\>
...
> **save**(`options?`): `Promise`\<`EmojiConfigSessionModel`\>
...
`SaveOptions`\<`EmojiConfigSessionModel`\>
...
`T` *extends* `EmojiConfigSessionModel`
...
> **update**\<`K`\>(`key`, `value`, `options?`): `Promise`\<`EmojiConfigSessionModel`\>
...
`Col` \| `Fn` \| `Literal` \| `EmojiConfigSessionModel`\[`K`\]

###### options?

`InstanceUpdateOptions`\<`EmojiConfigSessionModel`\>
...
> **update**(`keys`, `options?`): `Promise`\<`EmojiConfigSessionModel`\>
...
`EmojiConfigSessionModel` \| `Col` \| `Fn` \| `Literal`
...
`Col` \| `Fn` \| `Literal` \| `Model`\<`EmojiConfigSessionModel`, `EmojiConfigSessionModel`\>
...
`Col` \| `Fn` \| `Literal` \| ((`propertyKey`, `options?`) => `Promise`\<`number`\>)

###### $create?

`Col` \| `Fn` \| `Literal` \| (\<`R`\>(`propertyKey`, `values`, `options?`) => `Promise`\<`R`\>)

###### $get?

`Col` \| `Fn` \| `Literal` \| (\<`K`\>(`propertyKey`, `options?`) => `Promise`\<`$GetType`\<`EmojiConfigSessionModel`\[`K`\]\>\>)

###### $has?

`Col` \| `Fn` \| `Literal` \| (\<`R`\>(`propertyKey`, `instances`, `options?`) => `Promise`\<`boolean`\>)

###### $remove?

`Col` \| `Fn` \| `Literal` \| (\<`R`\>(`propertyKey`, `instances`, `options?`) => `Promise`\<`any`\>)
...
`Col` \| `Fn` \| `Literal` \| (\<`K`\>(`fields`, `options?`) => `Promise`\<`EmojiConfigSessionModel`\>)
...
`Col` \| `Fn` \| `Literal` \| (\{(`options?`): `EmojiConfigSessionModel`; \<`K`\>(`key`, `options?`): `EmojiConfigSessionModel`\[`K`\]; (`key`, `options?`): `unknown`; \})

###### getDataValue?

`Col` \| `Fn` \| `Literal` \| (\<`K`\>(`key`) => `EmojiConfigSessionModel`\[`K`\])
...
`Col` \| `Fn` \| `Literal` \| (\{(): `Partial`\<`TModelAttributes`\>; \<`K`\>(`key`): `EmojiConfigSessionModel`\[`K`\] \| `undefined`; \})

###### reload?

`Col` \| `Fn` \| `Literal` \| ((`options?`) => `Promise`\<`EmojiConfigSessionModel`\>)
...
`"statusEmoji"` \| `"pausedEmoji"` \| `"podcastStatusEmoji"` \| `"podcastPausedEmoji"` \| `Col` \| `Fn` \| `Literal`
...
`Col` \| `Fn` \| `Literal` \| (\{\<`K`\>(`key`, `value`, `options?`): `Promise`\<`EmojiConfigSessionModel`\>; (`keys`, `options?`): `Promise`\<`EmojiConfigSessionModel`\>; \})
