...
[spotify-status-bot](../../../../README.md) / [services/spotify/errors](../README.md) / SpotifyCurrentlyPlayingError

# Class: SpotifyCurrentlyPlayingError

Defined in: [src/services/spotify/errors.ts:60](https://github.com/tehJimboJones/spotify-slack-status-sync/blob/1e46a35f98db5d61d3f91586400e86d860cce2c4/src/services/spotify/errors.ts#L60)
...
> **new SpotifyCurrentlyPlayingError**(`message?`): `SpotifyCurrentlyPlayingError`

Defined in: [src/services/spotify/errors.ts:61](https://github.com/tehJimboJones/spotify-slack-status-sync/blob/1e46a35f98db5d61d3f91586400e86d860cce2c4/src/services/spotify/errors.ts#L61)

#### Parameters

##### message?

`string` = `'Failed to fetch currently playing track from Spotify'`
