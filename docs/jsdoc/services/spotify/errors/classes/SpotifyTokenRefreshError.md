...
[spotify-status-bot](../../../../README.md) / [services/spotify/errors](../README.md) / SpotifyTokenRefreshError

# Class: SpotifyTokenRefreshError

Defined in: [src/services/spotify/errors.ts:34](https://github.com/tehJimboJones/spotify-slack-status-sync/blob/1e46a35f98db5d61d3f91586400e86d860cce2c4/src/services/spotify/errors.ts#L34)
...
> **new SpotifyTokenRefreshError**(`message?`): `SpotifyTokenRefreshError`

Defined in: [src/services/spotify/errors.ts:35](https://github.com/tehJimboJones/spotify-slack-status-sync/blob/1e46a35f98db5d61d3f91586400e86d860cce2c4/src/services/spotify/errors.ts#L35)

#### Parameters

##### message?

`string` = `'Failed to refresh Spotify token'`
